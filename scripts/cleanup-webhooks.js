...
// Fonction pour lister les webhooks existants avec le bon paramètre
async function listWebhooks() {
    ...
    try {
        const response = await makeRequest(`https://api.figma.com/v2/webhooks?team_id=${TEAM_ID}&context=webhooks`, options);
